...
function connect() {
    ...
    // Crea un objeto socket que se conecta a la URL '/walgreeen'
    var socket = new SockJS('/walgreen');
    ...
    stompClient.connect({}, function (frame) {
        ...
        stompClient.subscribe('/user/specific', function (message) {
            ...
            stompClient.send('/app/recibir', {}, JSON.stringify({
                notificationID: JSON.parse(message.body).notificationID }));
