...
import com.example.senc4farming.dto.PythonScriptDto;
import com.example.senc4farming.model.Usuario;
import com.example.senc4farming.service.MenuService;
import com.example.senc4farming.service.PythonScriptService;
...
public class AppPythonScriptController extends AbstractController <PythonScriptDto> {
    ...
    public AppPythonScriptController(MenuService menuService, PythonScriptService service) {
        super(menuService);
    ...
    private static final String STR_NO_ENCONTRADO ="pythonscript/detallesnoencontrado";
    ...
    public String guardarEdicionDatos(@PathVariable("idusr") Integer id, PythonScriptDto dtoEntrada)  {
        //Obtenemos los datos del usuario
        Usuario usuario = ((SuperCustomerUserDetails) SecurityContextHolder.getContext().
        ...
        if (dtoControl.isPresent()){
            ...
            dtoEntrada.setId(id);
            dtoEntrada.setUsuarioPythonScript(usuario);
    ...
    public String guardar( @ModelAttribute(name ="datos") PythonScriptDto dto) {
        //Obtenemos los datos del usuario
        ...
        dto.setUsuarioPythonScript(usuario);
    ...
    public String vistaRegistroLaunch(@PathVariable("idevalscript") Integer idScript,Model interfazConPantalla){
        //Instancia en memoria del dto a informar en la pantalla
        Optional<PythonScriptDto> pythonScriptDto = this.service.encuentraPorId(idScript);
