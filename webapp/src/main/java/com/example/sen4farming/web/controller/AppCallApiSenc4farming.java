...
import com.example.sen4farming.apiitem.*;
...
import com.example.sen4farming.model.*;
...
public class AppCallApiSenc4farming extends AbstractController <GrupoTrabajoDto> {
    ...
    public AppCallApiSenc4farming(MenuService menuService,
                                  DatosUploadCsvService datosUploadCsvService, DatosLucas2018Service datosLucas2018Service,
                                  ...
                                  FiltroConsultaKalmanService filtroConsultaKalmanService, List<Listfilestiff> objlistfilestiff,
    ...
    public String getcredentials(  Model interfazConPantalla, HttpSession session){
        ...
        System.out.println(copernicuscredentials.getClientid());
        //Obtenemos los credenciales de sesión
        //Mediante "addAttribute" comparto con la pantalla
    ...
    public String listfilesPost( @ModelAttribute(name ="consulta") ListarArchivosDto listarArchivosDto,
        ...
        try {
            ...
            System.out.println(request1.errormessage);
            if (request1.errormessage == "") {
                System.out.println("Post pantalla de busqueda llamada realizada:" + request1.output);
                String jsonArray = request1.output;
                System.out.println("Post pantalla de busqueda json leido");
                System.out.println(jsonArray);
                try {
                    ...
                    strErrorMessage = "Error parsing Json , contact administrator";
                }
                ...
                System.out.println("Error Message en readerror");
                System.out.println(request1.errormessage);
                String jsonArray = request1.output;
                try {
                    JSONObject jsonObject = new JSONObject(jsonArray);
                    ...
                    while (keys.hasNext()) {
                        String key = keys.next();
                        if (jsonObject.get(key) instanceof JSONObject) {
                            System.out.println("Key primer nivel");
                            // do something with jsonObject here
                            JSONObject jsonObject1 = ((JSONObject) jsonObject.getJSONObject(key));
                            Iterator<String> keysint = ((JSONObject) jsonObject.get(key)).keys();
                            while (keysint.hasNext()) {
                                System.out.println("Key segundo nivel");
                                String keyint = keysint.next();
                                System.out.println(keyint + ":" + jsonObject1.get(keyint).toString());
                                if (keyint.equals("message")){
                                    strErrorMessage =  jsonObject1.get(keyint).toString();
                                }
                ...
                interfazConPantalla.addAttribute("errorMessage", strErrorMessage);
    ...
    public String checkpolygosize( @ModelAttribute(name ="consulta") ListarArchivosDto listarArchivosDto,
        ...
        System.out.println("En /api/checkpolygosize post");
        //Objeto para guardar el filtro de la consulta
        FiltroListarArchivosDto filtroListarArchivosDto = new FiltroListarArchivosDto();
        //Mensaje de error
        String strErrorMessage = "";
        ...
        String urltext = "http://" + configuationProperties.getIppythonserver() + ":8100/api/checkpolygosize/";
    ...
    public String executeevalscript(@ModelAttribute(name ="datosscript") EvalScriptDto dtoEvalscript,
        ...
        if (cliId != null){
            ...
            try {
                ...
                System.out.println(e.getMessage());
                interfazConPantalla.addAttribute("resultado", "Error Message :" + e.getClass().getSimpleName() + e.getMessage());
                return String.format("redirect:/evalscript");
            }
        } else {
            interfazConPantalla.addAttribute("consulta",copernicuscredentials);
            return "redirect:/api/credentials";
    ...
    public ResponseEntity<byte[]> csvuserFile (@PathVariable("id") Integer id,
                                               Model interfazConPantalla){
        System.out.println("csvuserFile: paso1");
        List<DatosUploadCsvDto> lstdatosUploadCsvDto = datosUploadCsvService.getUploadedCsvDataSearchId(id);
    ...
    public String csvreflvectors (@PathVariable("id") Integer id,@PathVariable("opt")Integer opt,Model interfazConPantalla,HttpSession session) throws Exception {
        ...
        if (optuploadedFilesDto.isPresent()) {
            //componemos la url
            String urltext = "http://" + configuationProperties.getIppythonserver() + ":8100/api/obtenercsvproc/reflvector/copsh/";
            //Obtenemos los datos del usuario de la sesión
            SuperCustomerUserDetails superCustomerUserDetails = (SuperCustomerUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
            System.out.println(superCustomerUserDetails.getUsername());
            ...
            try {
                ...
                requestParam.put("path", optuploadedFilesDto.get().getPath()+"/"+optuploadedFilesDto.get().getDescription());
                //Comprobamos el patron
                //Se invoca a la URL
                System.out.println("/api/uploadedfiles/csv/reflvectors/copsh/: Post pantalla de busqueda 50");
                Request request1 = new Request(urltext, requestParam);
                System.out.println("/api/uploadedfiles/csv/reflvectors/copsh/: Post pantalla de busqueda 60");
                String jsonArray = request1.output;
                System.out.println("/api/uploadedfiles/csv/reflvectors/copsh/: Post pantalla de busqueda 80");
                try {
                    JSONObject jsonObject = new JSONObject(jsonArray);
                    Iterator<String> keys = jsonObject.keys();
                        ...
                        if (jsonObject.get(key) instanceof JSONObject) {
                            ...
                            while (keysint.hasNext()) {
                                ...
                                if (itemlistCheck.getKeyapi().equals(-1)) {
                                    ...
                                    SetlistdatosuploadcsvOCfield(key, jsonObject1, keyint, itemlistCheck, 0);
                                } else {
                                    // You use this ".get()" method to actually get your Listfiles from the Optional object
                                    System.out.println("/api/uploadedfiles/csv/reflvectors/copsh/ post   valores para el json existe indice");

                                    objlistdatosuploadcsvApi.remove(itemlistCheck);
                                    SetlistdatosuploadcsvOCfield(key, jsonObject1, keyint, itemlistCheck, 1);
                                }
                            }
                        }
                    }
                ...
                System.out.println("/api/uploadedfiles/csv/reflvectors/copsh/: Post pantalla de busqueda 100");
                //id unico de la busqueda
                Random r = new Random();
                int low = 10;
                int high = 1000000;
                ...
                if (!objlistdatosuploadcsvApi.isEmpty()) {
                    System.out.println("/api/uploadedfiles/csv/reflvectors/copsh/: Post pantalla de busqueda 110");
                    //Guardamos los datos en la tabla
                    ...
                    while (it.hasNext()) {
                        ...
                        DatosUploadCsvDto dtosaved = datosUploadCsvService.guardar(dto);
                        System.out.println("Encuentro elemento guardado");
                        System.out.println(dtosaved.getId());
                        System.out.println(dtosaved.getPointid());
                    ...
                    List<DatosUploadCsvDto> sortedItems = lstdatosUploadCsvDto.stream()
                            ...
                            .collect(Collectors.toList());
                    System.out.println("elementos de la lista sortedItems");
                    System.out.println(sortedItems.size());
                    datosUploadCsvService.guardar(sortedItems);

                    System.out.println("result" );
                    System.out.println(result);
                    List<DatosUploadCsvDto> datosUploadCsvDtos = datosUploadCsvService.getUploadedCsvData(result,optuploadedFilesDto.get().getPath());
                    interfazConPantalla.addAttribute("lista", sortedItems);
                    interfazConPantalla.addAttribute("idres",result);
                    System.out.println("elementos de la lista");
                    System.out.println(datosUploadCsvDtos.size());
                    return "upload/listareflvectors";
                } else {
                    System.out.println("/api/uploadedfiles/csv/reflvectors/copsh/: Post pantalla de busqueda 210");
    ...
    public String csvreflvectorsgee (@PathVariable("id") Integer id,@PathVariable("opt")Integer opt, Model interfazConPantalla,HttpSession session) throws Exception {
        //Buscamos los datos del archivo csv en la bbdd
        Optional<UploadedFilesDto> optuploadedFilesDto = uploadedFilesService.encuentraPorId(id);
        System.out.println("getreflecance : elemento leido");
        if (optuploadedFilesDto.isPresent()) {
            //componemos la url
            String urltext = "http://" + configuationProperties.getIppythonserver() + ":8100/api/obtenercsvproc/reflvector/gee/";
            //Obtenemos los datos del usuario de la sesión
            SuperCustomerUserDetails superCustomerUserDetails = (SuperCustomerUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
            System.out.println(superCustomerUserDetails.getUsername());
            ...
            try {
                ...
                //Comprobamos el patron
                //Se invoca a la URL
                System.out.println("/api/uploadedfiles/csv/reflvectors/gee/: Post pantalla de busqueda 50");
                Request request1 = new Request(urltext, requestParam);
                System.out.println("/api/uploadedfiles/csv/reflvectors/gee/: Post pantalla de busqueda 60");
                String jsonArray = request1.output;
                System.out.println("/api/uploadedfiles/csv/reflvectors/gee/: Post pantalla de busqueda 80");
                try {
                    JSONObject jsonObject = new JSONObject(jsonArray);
                    Iterator<String> keys = jsonObject.keys();
                        ...
                        if (jsonObject.get(key) instanceof JSONObject) {
                            ...
                            while (keysint.hasNext()) {
                                ...
                                if (itemlistCheck.getKeyapi().equals(-1)) {
                                    ...
                                    // You use this ".get()" method to actually get your Listfiles from the Optional object
                                    System.out.println("/api/uploadedfiles/csv/reflvectors/gee/ post   valores para el json existe indice");
                ...
                System.out.println("/api/uploadedfiles/csv/reflvectors/gee/: Post pantalla de busqueda 100");
                //id unico de la busqueda
                Random r = new Random();
                int low = 10;
                int high = 1000000;
                ...
                //comprobamos si hay datos
                if (!objlistdatosuploadcsvApi.isEmpty()) {
                    System.out.println("/api/uploadedfiles/csv/reflvectors/gee/: Post pantalla de busqueda 110");
                    //Guardamos los datos en la tabla
                    Iterator<DatosUploadCsvApi> it = objlistdatosuploadcsvApi.iterator();
                    List<DatosUploadCsvDto> lstdatosUploadCsvDto = new ArrayList<>();
                    // mientras al iterador queda proximo juego
                    ...
                    System.out.println("/api/uploadedfiles/csv/reflvectors/gee/: Post pantalla de busqueda 210");
                    return "upload/detallesnoencontrado";
                }
    ...
    @GetMapping ("/api/uploadedfiles/csv/getsocvalues/copsh/{opt}/{id}")
    public String csvgetsocvaluescopsh (@PathVariable("id") Integer id,@PathVariable("opt")Integer opt,Model interfazConPantalla,HttpSession session) throws Exception {
        //Buscamos los datos del archivo csv en la bbdd
        Optional<UploadedFilesDto> optuploadedFilesDto = uploadedFilesService.encuentraPorId(id);
        System.out.println("getreflecance : elemento leido");
        if (optuploadedFilesDto.isPresent()) {
            //componemos la url
            String urltext = "http://" + configuationProperties.getIppythonserver() + ":8100/api/obtenercsvproc/getsocvalues/copsh/";
            return "upload/detallesnoencontrado";
        }
        else{
            return "upload/detallesnoencontrado";
    ...
    @GetMapping ("/api/uploadedfiles/csv/getsocvalues/gee/{opt}/{id}")
    public String csvgetsocvaluesgee (@PathVariable("id") Integer id,@PathVariable("opt")Integer opt, Model interfazConPantalla,HttpSession session) throws Exception {
        //Buscamos los datos del archivo csv en la bbdd
        Optional<UploadedFilesDto> optuploadedFilesDto = uploadedFilesService.encuentraPorId(id);
        System.out.println("getreflecance : elemento leido");
        if (optuploadedFilesDto.isPresent()) {
            //componemos la url
            String urltext = "http://" + configuationProperties.getIppythonserver() + ":8100/api/obtenercsvproc/getsocvalues/gee/";
            //Obtenemos los datos del usuario de la sesión
            SuperCustomerUserDetails superCustomerUserDetails = (SuperCustomerUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
            System.out.println(superCustomerUserDetails.getUsername());
            return "upload/detallesnoencontrado";
    ...
    public String listaimodels (Model interfazConPantalla,HttpSession session) throws Exception {
        //componemos la url
        String urltext = "http://" + configuationProperties.getIppythonserver() + ":8100/api/ai/models";
        //Obtenemos los datos del usuario de la sesión
        String userName = "no informado";
        SuperCustomerUserDetails superCustomerUserDetails = (SuperCustomerUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        System.out.println(superCustomerUserDetails.getUsername());
        ...
        try {
                    ...
                    if (jsonObject.get(key) instanceof JSONObject) {
                        ...
                        while (keysint.hasNext()) {
                            ...
                            if (itemlistCheck.getKey().equals(-1)) {
                                ...
                                SetAIModelsfield(key, jsonObject1, keyint, itemlistCheck, 0);
                            } else {
                                // You use this ".get()" method to actually get your Listfiles from the Optional object
                                System.out.println("/api/listfiles/executeevalscript post   valores para el json existe indice");

                                objListAIModels.remove(itemlistCheck);
                                SetAIModelsfield(key, jsonObject1, keyint, itemlistCheck, 1);
                            }
                        }
                    }
                }
            ...
            if (!objListAIModels.isEmpty()) {
                ...
                //Se muestra el listado
                interfazConPantalla.addAttribute("lista", objListAIModels);
                return "aimodels/models";
            } else {
                return "aimodels/detallesnoencontrado";
            }
    ...
    public String querypoint (@PathVariable("ref") String ref,Model interfazConPantalla,HttpSession session) throws Exception {
        QuerySocDto querySocDto = new QuerySocDto();
        querySocDto.setReference(ref);
        interfazConPantalla.addAttribute("datos",querySocDto);

        return "aimodels/query";
    }

    @PostMapping("/api/ai/models/{ref}/ejecutar")
    public String querypointPost (@PathVariable("ref") String ref,QuerySocDto querySocDtoEntrada, Model interfazConPantalla,HttpSession session) throws Exception {
        //provisional
        String aux = "";
        if (ref.contains("knn")){
            aux = "knn";
        ...
        //componemos la url
        String urltext = "http://" + configuationProperties.getIppythonserver() + ":8100/api/ai/pred/" + aux;
        //Obtenemos los datos del usuario de la sesión
        String userName = "no informado";
        SuperCustomerUserDetails superCustomerUserDetails = (SuperCustomerUserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        System.out.println(superCustomerUserDetails.getUsername());
        ...
        try {
            ...
            requestParam.put("pointid",querySocDtoEntrada.getPoint_id());
            ...
            requestParam.put("offset",configuationProperties.getOffset());
            requestParam.put("cloudcover",querySocDtoEntrada.getCloudcover());
            requestParam.put("numberOfGeeImages",configuationProperties.getNumberOfGeeImages());
            requestParam.put("reference",ref);

            //Se invoca a la URL
            System.out.println("Post pantalla de busqueda 550");
            Request request1 = new Request(urltext, requestParam);
            String jsonArray = request1.output;

            querySocDtoEntrada.setSoc(jsonArray);
            interfazConPantalla.addAttribute("datos",querySocDtoEntrada);
