...
var v_lat = parseFloat(document.getElementById("lat").value)
var v_long= parseFloat(document.getElementById("long").value)
//kml files
...
function getpointcoords(){
    var v_lat_i = document.getElementById("lat")
    var v_long_i= document.getElementById("long")
    var pointCoords_l_i =  '[' + parseFloat(v_long_i.value) + ',' + parseFloat(v_lat_i.value)  + ']'
    return pointCoords_l_i
    }
